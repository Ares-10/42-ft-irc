...
public:
	...
	// 462
	static std::string err_unauthorizedcommand(const std::string &client_name, const std::string &command);

	// 431
	static std::string err_nonicknamegiven(const std::string &client_name, const std::string &command);
